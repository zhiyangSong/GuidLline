...
_STATUSPB = _descriptor.Descriptor(
  name='StatusPb',
  full_name='haomo.hios.StatusPb',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error_code', full_name='haomo.hios.StatusPb.error_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='msg', full_name='haomo.hios.StatusPb.msg', index=1,
...
StatusPb = _reflection.GeneratedProtocolMessageType('StatusPb', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:haomo.hios.StatusPb)
  })
