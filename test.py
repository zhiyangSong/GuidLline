import os 
from process import  plotMap, plotLane, getTrainData ,getTrainData2 ,getTrainData3
import numpy as np
import glob
...
for i in path_data_number:
    print(i)
    fectures, labels = getTrainData2(juncDir = laneDir,traDir = i+'/',limit_1=-200, limit_2=-100)
    fec.append(fectures)
    lab.append(labels)
...
for i in path_data_number3:
    print(i)
    fectures, labels = getTrainData2(juncDir = laneDir,traDir =i+"/",  limit_1=-850, limit_2=-700)
    fec.append(fectures)
    lab.append(labels)
