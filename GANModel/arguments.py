...
def get_common_args():
    ...
    parser.add_argument('--save_dir', type=str, default="./modelgan")
    parser.add_argument('--log_dir', type=str, default="./loggan")
    ...
    parser.add_argument('--max_steps', type=int, default=200, help='the max number of step for a episode')
