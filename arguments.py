...
def get_common_args():
    ...
    parser.add_argument("--input_size", type=int, default=20, help="input size")
    parser.add_argument("--output_size", type=int, default=10, help="output size: B-spline contral points")
